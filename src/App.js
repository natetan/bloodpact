...
class App extends Component {
  ...
  render() {
    let signUpView = (routerProps) => {
      return (
        <SignUpView {...routerProps} errorMessage={this.state.errorMessage} handleSignUp={this.handleSignUp} />
      )
    }

    let signInView = (routerProps) => {
      return (
        <SignInView {...routerProps} errorMessage={this.state.errorMessage} handleSignIn={this.handleSignIn} />
      )
    }
    ...
    if (this.state.user) {
      ...
      nav = <MainNavBar displayName={this.state.user.displayName} email={this.state.user.email} handleSignOut={this.handleSignOut} />;
    } else {
      nav = <MainNavBar />;
    }
